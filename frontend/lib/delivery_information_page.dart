...
class DeliveryInformationPage extends StatefulWidget {
  ...
  @override
  _DeliveryInformationPageState createState() =>
      _DeliveryInformationPageState();
}
...
class _DeliveryInformationPageState extends State<DeliveryInformationPage> {
  ...
  void initState() {
    ...
    // Try to get user's name and phone from auth provider
    _loadUserDetails();
  }
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            Text(
              'Please confirm and complete your delivery details:',
