...
class FitnessCategoriesPage extends StatefulWidget {
  ...
  @override
  State<FitnessCategoriesPage> createState() => _FitnessCategoriesPageState();
}

class _FitnessCategoriesPageState extends State<FitnessCategoriesPage> {
  ...
  Future<void> _loadMenu() async {
    try {
      final menu = await _apiService.fetchMenu(
        ...
        nutsFree: false,
        isHighProtein: _selectedCategoryIndex == 0 ? true : null,
        isLowCarb: _selectedCategoryIndex == 1 ? true : null,
        isBalanced: _selectedCategoryIndex == 2 ? true : null,
        isBulkUp: _selectedCategoryIndex == 3 ? true : null,
      );
      setState(() {
