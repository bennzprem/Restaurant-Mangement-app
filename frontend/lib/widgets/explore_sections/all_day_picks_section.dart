...
// File: all_day_picks_section.dart
// File: all_day_picks_section.dart

import 'package:flutter/material.dart';
import '../shared/card_carousel.dart'; // Import the new widget

class AllDayPicksSection extends StatefulWidget {
  const AllDayPicksSection({super.key});

  @override
  State<AllDayPicksSection> createState() => _AllDayPicksSectionState();
}

class _AllDayPicksSectionState extends State<AllDayPicksSection> {
