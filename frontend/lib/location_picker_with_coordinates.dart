...
class LocationPickerWithCoordinates extends StatefulWidget {
  const LocationPickerWithCoordinates({super.key});

  @override
  _LocationPickerWithCoordinatesState createState() =>
      _LocationPickerWithCoordinatesState();
}

class _LocationPickerWithCoordinatesState
    extends State<LocationPickerWithCoordinates> {
        ...
        children: [
          ...
          Container(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                // Return the location with coordinates
